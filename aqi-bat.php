...
if ($useLiveData) {
  // Sierra Point
  // $contents = file_get_contents('https://www.purpleair.com/json?key=XDLPNJRGL7S1G4JA&show=53461');
  // San Benito
  $contents = file_get_contents('https://www.purpleair.com/json?key=VG6SPX3AMNOR6MKW&show=55195');
}
