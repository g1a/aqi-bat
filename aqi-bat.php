...
$state = json_decode(file_get_contents($stateFilename), true) + ['last-notification' => null];
unset($state['error']);
unset($state['error-timestamp']);
unset($state['error-contents']);
